/**
 * BootstrapValidator v0.2.3 (https://github.com/nghuuphuoc/bootstrapvalidator)
 *
        ...
        _initField: function(field) {
            ...
            if (helpBlock.length == 0) {
                ...
                if (label = $parent.find('label').get(0)) {
                    // The default Bootstrap form don't require class for label (https://getbootstrap.com/css/#forms)
