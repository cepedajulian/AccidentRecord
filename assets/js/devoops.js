...
// homepage: https://arshaw.com/fullcalendar
// require moment.js
//
...
function LoadOpenLayersScript(callback){
	if (!$.fn.OpenLayers){
		$.getScript('https://www.openlayers.org/api/OpenLayers.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
//  homepage: https://datatables.net v1.9.4 license - GPL or BSD
//
function LoadDataTablesScripts(callback){
	function LoadDatatables(){
		$.getScript(path+'plugins/datatables/jquery.dataTables.js', function(){
			$.getScript(path+'plugins/datatables/ZeroClipboard.js', function(){
				$.getScript(path+'plugins/datatables/TableTools.js', function(){
					$.getScript(path+'plugins/datatables/dataTables.bootstrap.js', callback);
				});
			});
		});
	}
...
//  homepage: https://tenxer.github.io/xcharts/ v0.3.0 license - MIT
//  Required D3 plugin https://d3js.org/ v3.4.1 license - MIT
//
...
//  homepage: https://www.flotcharts.org  v0.8.2 license- MIT
//
...
//  homepage: https://www.oesmith.co.uk/morris.js/ v0.4.3 License - MIT
//  require Raphael https://raphael.js
//
...
//  homepage: https://fancyapps.com/fancybox/ v2.1.5 License - MIT
//
...
//  homepage: https://anthonyterrien.com/knob/  v1.2.5 License- MIT or GPL
//
...
//  homepage: https://omnipotent.net/jquery.sparkline v2.1.2  License - BSD
//
...
function ScreenSaver(){
	...
	function draw() {
		...
		for(var i = 0; i < particles.length; i++){
			...
			// https://physics.about.com/od/mathematics/a/VectorMath.htm
...
function CoinDeskGraph(){
	...
	var jsonURL = 'https://api.coindesk.com/v1/bpi/historical/close.json?start='+startdate+'&end='+enddate;
