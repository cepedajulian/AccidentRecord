...
<div id="content" class="col-xs-12 col-sm-10">
	...
	<div class="row">
		<div id="breadcrumb" class="col-md-12">
			...
			<ol class="breadcrumb">
				...
				<li><a href="#">Importaci&oacute;n de Localidades</a></li>
			</ol>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-xs-12">
			<h3 class="page-header">Importaci&oacute;n de Localidades</h3>
			<BR>
	...
	<?php echo form_open_multipart('config/importlocalidades', array('id' => 'localidadesForm', 'class'=> 'form-horizontal bootstrap-validator-form')); ?>
			...
			<div class="box">
				<div class="box-header">
					<div class="box-name">
						...
						<span>Carga de Localidades</span>
					</div>
					<div class="box-icons">
				...
				<div class="box-content no-padding">
					...
					<fieldset>
						<div class="form-group">
							<input type="hidden" value="1" name="sendform">
							<label class="col-sm-3 control-label">Seleccionar archivo de localidades:</label>
							<div class="col-sm-8"> 
								...
								<br /><br />
								<a href="#" onclick="$('#progress').css('display','block');$('#localidadesForm').submit()">
					...
					<?php if (isset($procesados)){
						...
						echo "<b>Cantidad de localidades nuevas:</b> ".$agregados."<br>";
						echo "<b>Cantidad de localidades actualizadas:</b> ".$actualizados."<br>";
